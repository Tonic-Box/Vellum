...
/**
 * Width-aware greedy word wrapping. Breaks at spaces, hard-breaks words wider than the
 * width, and measures with {@link CharWidth} so wide glyphs never straddle a boundary.
 */
final class TextWrap {

    private TextWrap() {}

    /** Wrap a single logical line to {@code width} display columns. Always returns >= 1 line. */
    ...
    /** Wrap each newline-delimited logical line, concatenating the results. */
